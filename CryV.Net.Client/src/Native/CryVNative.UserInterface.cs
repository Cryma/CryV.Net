...
namespace CryV.Net.Client.Native
{
    public static partial class CryVNative
    {
        ...
        [DllImport(_dllLocation, CallingConvention = CallingConvention.StdCall)]
        public static extern void Native_UserInterface_BeginTextCommandGetWidth(IntPtr plugin, IntPtr componentType);
        ...
        [DllImport(_dllLocation, CallingConvention = CallingConvention.StdCall)]
        public static extern float Native_UserInterface_EndTextCommandGetWidth(IntPtr plugin, bool p0);
